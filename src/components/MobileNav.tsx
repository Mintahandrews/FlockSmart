...
const MobileNav: React.FC<MobileNavProps> = ({ notificationCount }) => {
  ...
  return (
    <>
      <div className="bg-white border-b border-gray-200 px-4 py-3 flex justify-between items-center w-full">
        <button
          onClick={toggleMenu}
          className="text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 p-1 rounded-md hover:bg-gray-100"
        >
        ...
        <div className="flex items-center">
          ...
          <h1 className="text-lg font-semibold text-gray-800">FlockSmart</h1>
        </div>
        <div className="relative">
          <Bell className="h-6 w-6 text-gray-700 hover:text-gray-900" />
          {notificationCount > 0 && (
            <span className="absolute -top-1 -right-1 bg-red-500 text-white rounded-full text-xs min-w-[20px] h-5 flex items-center justify-center px-1">
        ...
        <div className="fixed inset-0 z-50 bg-white">
          <div className="flex flex-col h-full">
            ...
            <nav className="flex-1 overflow-y-auto pb-safe">
              ...
              {user && (
                <div className="fixed bottom-0 left-0 right-0 p-4 bg-white shadow-t">
                  <div className="flex items-center">
